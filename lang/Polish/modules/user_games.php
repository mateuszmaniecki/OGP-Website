...
define('OGP_LANG_game_path', "Ścieżka gry");
define('OGP_LANG_game_path_info', "Bezwzględna ścieżka gry. Przykładowo: /home/ogpbot/OGP_User_Files/My_Server");
...
define('OGP_LANG_add_game_home', "Dodaj serwer");
define('OGP_LANG_game_path_empty', "Ściezka do gry nie może być pusta.");
...
define('OGP_LANG_no_remote_servers_configured', "Nie posiadasz skonfigurowanych serwerów zdalnych.<br>Musisz dodać zdalny serwer by móc tworzyć gry.");
define('OGP_LANG_no_game_configurations_found', "Nie znaleziono konfiguracji gry. Musisz ją dodać z");
define('OGP_LANG_game_configurations', ">game configuration page");
define('OGP_LANG_add_remote_server', "Dodaj zdalny serwer.");
...
define('OGP_LANG_change_home', "Zmień ścieżkę");
...
define('OGP_LANG_max_players', "Maksymalna ilośc graczy");
...
define('OGP_LANG_nice_level', "Wysokość priorytetu");
...
define('OGP_LANG_back_to_game_monitor', "z powrotem do monitorów gry");
define('OGP_LANG_back_to_game_servers', "z powrotem do serwerów gier");
...
define('OGP_LANG_control_password_updated_successfully', "Hasło kontrolne zaktualizowane poprawnie.");
define('OGP_LANG_control_password_update_failed', "Hasło kontrolne nie mogło zostać zaktualizowane.");
define('OGP_LANG_successfully_changed_game_server', "Pomyślnie zmieniono nazwę serwera.");
define('OGP_LANG_error_ocurred_on_remote_server', "Error ocurred on remote server,");
define('OGP_LANG_ftp_password_can_not_be_changed', "Hasło FTP nie może zostać zmienione.");
...
define('OGP_LANG_ip_port_already_in_use', " %s:%s jest obecnie w użyciu. Wybierz inny dostępny IP:port.");
define('OGP_LANG_successfully_assigned_ip_port_to_server_id', "Pomyślnie przypisano %s:%s do serwera ID %s.");
...
define('OGP_LANG_successfully_removed_mod', "Pomyślnie usunięto konfigurację gry.");
...
define('OGP_LANG_save_as_default_for_this_mod', "Zapisz ten mod jako domyślny");
...
define('OGP_LANG_change_ftp_account_status', "Zmień status konta FTP");
...
define('OGP_LANG_server_ftp_login', "Login do serwera FTP");
define('OGP_LANG_change_ftp_login_info', "Change the FTP Login with a customized one.");
define('OGP_LANG_change_ftp_login', "Zmień login do FTP");
...
define('OGP_LANG_change_game_type', "Zmień silnik gry");
define('OGP_LANG_change_game_type_info', "Zmieniejąc silnik gry obecne pliki konfiguracyjne zostaną skasowane.");
...
define('OGP_LANG_game_home_name', "Nazwa serwera gry");
define('OGP_LANG_clone', "Sklonuj");
define('OGP_LANG_unassign', "Nieprzypisany");
...
define('OGP_LANG_allow_custom_fields', "Pozwól na niestandardowe pola");
...
define('OGP_LANG_cpu_affinity_info', "Wybierz rdzeń procesora który chcesz przypisać do serwera gry.");
