...
define('OGP_LANG_update_complete', "Aktualizacja zakończona.");
define('OGP_LANG_ignored_files', "%s zignorowanych pliki.");
define('OGP_LANG_not_updated_files_blacklisted', "Nie zaktualizowano plików (czarna lista):<br>%s");
...
define('OGP_LANG_the_panel_is_up_to_date', "Posiadasz aktualną wersję panelu.");
define('OGP_LANG_files_overwritten', "%s nadpisanych pliki");
...
define('OGP_LANG_query_failed', "Błąd wykonania zadania");
